...
function btn1() {
    ...
    if(turn%2==0){
        // console.log("클릭되었습니다.");
        comTotalScoreElem.innerHTML = com_score;
        ...
        notice.style.fontSize = "0";
        userTotalScoreElem.innerHTML = user_score;
        let com_strike = Math.ceil(Math.random() * 100);
        if (com_strike < 6) { // com_strike가 5%의 확률로 홈런일 때
            ...
            strike += 1;
            console.log("strike:",strike);
        } else if (com_strike >= 56 && com_strike < 81) { // com_strike이 46-80일 때 (25% 확률)
...
function sboCount() {
    ...
    if (turn==18){
        if (comTotalScoreElem === userTotalScoreElem){
            notice.style.color = "black";
            noticeElem.innerHTML = "DRAW";
            notice.innerHTML = "DRAW";
        }else if (comTotalScoreElem > userTotalScoreElem){
            notice.style.color = "black";
            noticeElem.innerHTML = "컴퓨터의 승리 !";
            notice.innerHTML = "컴퓨터";
        }else {
            notice.style.color = "black";
            noticeElem.innerHTML = `${userName}님의 승리 !`;
            notice.innerHTML = `${userName}`;
        }
    }
...
function endGame() {
    // 결과 공지
    if(turn==18){
        if (comTotalScoreElem === userTotalScoreElem) alert("비겼습니다.");
        else if (comTotalScoreElem > userTotalScoreElem) alert(`${userName}님이 졌습니다 !`);
        else alert(`${userName}님이 이겼습니다 !`);
    }else {}   
}  

//change players img
let chPitcher = document.querySelector(".pitcher");
let chCatcher = document.querySelector(".catcher");
let chHitter = document.querySelector(".hitter");
let chBase1 = document.querySelector(".base1");
let chBase2 = document.querySelector(".base2");
let chBase3 = document.querySelector(".base3");
let chDefender1 = document.querySelector(".defender1");
let chDefender2 = document.querySelector(".defender2");
let chDefender3 = document.querySelector(".defender3");